    ...
    return (
        <header className="relative w-full flex items-center justify-between px-6 py-4 bg-black z-50 border-b border-gray-800">
            ...
            <div className="relative flex items-center gap-2">
                <img src='https://i.pinimg.com/564x/a4/70/94/a4709409b20fb316551a020aa7379402.jpg' className="w-12 h-12 rounded-md border border-[#84A600]" alt="Seu perfil" />
                <IoMdArrowDropdown
                ...
                {showDropdown && (
                    <div className="absolute top-full right-0 mt-2 w-48 bg-black text-white border border-[#84A600] rounded-md shadow-lg z-50">
                        <ul className="flex flex-col">
                            <li
                                className="px-4 py-2 hover:bg-[#84A600] hover:text-black cursor-pointer"
